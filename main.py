...
if __name__=='__main__':
    ...
    while screen.running==True:
        ...
        #zero = screen.base_font.render(screen.label_car0, True, (255,255,255))
        #um = screen.base_font.render(screen.label_car1, True, (255,255,255))
        #dois = screen.base_font.render(screen.label_car2, True, (255,255,255))
        #tres = screen.base_font.render(screen.label_car3, True, (255,255,255))
        #quatro = screen.base_font.render(screen.label_car4, True, (255,255,255))
        #cinco = screen.base_font.render(screen.label_car5, True, (255,255,255))
        #seis = screen.base_font.render(screen.label_car6, True, (255,255,255))
        #sete = screen.base_font.render(screen.label_car7, True, (255,255,255))
        #oito = screen.base_font.render(screen.label_car8, True, (255,255,255))
        #nove = screen.base_font.render(screen.label_car9, True, (255,255,255))
        #st_car0 = screen.base_font.render(screen.status_car0, True,(255,255,255))
        #st_car1 = screen.base_font.render(screen.status_car1, True,(255,255,255))
        #st_car2 = screen.base_font.render(screen.status_car2, True,(255,255,255))
        #st_car3 = screen.base_font.render(screen.status_car3, True,(255,255,255))
        #st_car4 = screen.base_font.render(screen.status_car4, True,(255,255,255))
        #st_car5 = screen.base_font.render(screen.status_car5, True,(255,255,255))
        #st_car6 = screen.base_font.render(screen.status_car6, True,(255,255,255))
        #st_car7 = screen.base_font.render(screen.status_car7, True,(255,255,255))
        #st_car8 = screen.base_font.render(screen.status_car8, True,(255,255,255))
        #st_car9 = screen.base_font.render(screen.status_car9, True,(255,255,255))
        ...
        #screen.screen.blit(zero, (10,465))
        #screen.screen.blit(um, (10,485))
        #screen.screen.blit(dois, (10,505))
        #screen.screen.blit(tres, (10,525))
        #screen.screen.blit(quatro, (10,545))
        #screen.screen.blit(cinco, (10,565))
        #screen.screen.blit(seis, (10,585))
        #screen.screen.blit(sete, (10,605))
        #screen.screen.blit(oito, (10,625))
        #screen.screen.blit(nove, (10,645))
        #screen.screen.blit(st_car0, (80,465))
        #screen.screen.blit(st_car1, (80,485))
        #screen.screen.blit(st_car2, (80,505))
        #screen.screen.blit(st_car3, (80,525))
        #screen.screen.blit(st_car4, (80,545))
        #screen.screen.blit(st_car5, (80,565))
        #screen.screen.blit(st_car6, (80,585))
        #screen.screen.blit(st_car7, (80,605))
        #screen.screen.blit(st_car8, (80,625))
        #screen.screen.blit(st_car9, (80,645))
